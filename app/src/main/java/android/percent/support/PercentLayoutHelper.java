 ...
 * {@link android.percent.support.PercentLayoutHelper.PercentLayoutParams}.
 ...
 * method that you implemented for {@link android.percent.support.PercentLayoutHelper.PercentLayoutParams} interface.
 * <li> Override
...
public class PercentLayoutHelper
{
    ...
    private void supportTextSize(int widthHint, int heightHint, View view, PercentLayoutInfo info)
    {
        ...
        //Button 鍜�EditText 鏄疶extView鐨勫瓙绫�?        if (view instanceof TextView)
        {
    ...
    static PercentLayoutInfo.PercentVal percentVal;

    private static PercentLayoutInfo setTextSizeSupportVal(TypedArray array, PercentLayoutInfo info)
    {
        //textSizePercent 榛樿浠ラ珮搴︿綔涓哄熀鍑�        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, R.styleable.PercentLayout_Layout_layout_textSizePercent, false);
        if (percentVal != null)
        {
            if (Log.isLoggable(TAG, Log.VERBOSE))
            {
