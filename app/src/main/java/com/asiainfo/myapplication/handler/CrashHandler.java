package com.asiainfo.myapplication.handler;
...
/**
 * Created by zhujialin on 6/3/17.
 */

public class CrashHandler implements Thread.UncaughtExceptionHandler {


    public static final String TAG = "CrashHanlder";

    // the default uncaught exception handler of the system
    ...
    private DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd-mm-ss");
